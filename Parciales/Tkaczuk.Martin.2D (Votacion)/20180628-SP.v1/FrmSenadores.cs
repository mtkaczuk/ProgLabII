...
namespace _20180628_SP.v1
{
    public partial class FrmSenadores : Form
    {
        ...
        const string NOMBRE_TABLA_DB = "Votaciones";
        private static string nombreArchivoBinario;
        

        static FrmSenadores()
        {
            string folder = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
            nombreArchivoBinario = folder + "\votacionPrevia.dat";
        }
        ...
        public void ManejadorVoto(string senador, Votacion.EVoto voto)
        {
            ...
            else
            {
                ...
                if (aux == 0)
                {
                    ...
                    // Guardar resultados
                    Dao dao= new Dao();
                    dao.Guardar(NOMBRE_TABLA_DB , votacion);
